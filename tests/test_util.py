...
# Correlation Heatmap test for correct return type
...
# Correlation Heatmap test for raising of error if method is invalid
...
# Correlation Heatmap test for empty dataframe input
...
# Correlation Heatmap test for categorical columns input 
...
# Correlation Heatmap test for correct type for calculated values
...
# Correlation Heatmap test for correct calculation
...
# Correlation Heatmap test for correct labels
